-- #1
/* List each country name where the population is larger than that of 'Russia\'92.*/\
...
-- #2
/*Show the countries in Europe with a per capita GDP greater than 'United Kingdom\'92.*/\
select name from world \
